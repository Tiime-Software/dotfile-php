...
class CaseGetAllInputTest extends TestCase
{
    public function testUriWithAllFields(): void
    {
        ...
        $input->externalIdOperator = ExternalIdOperator::NOT_EQ;
        ...
        $input->createdAtOperator = DatetimeOperator::NOT_EQ;
        $input->updatedAt = new \DateTimeImmutable('2023-01-02');
        $input->updatedAtOperator = DatetimeOperator::NOT_EQ;
        $input->lastActivityAt = new \DateTimeImmutable('2023-01-03');
        $input->lastActivityAtOperator = DatetimeOperator::NOT_EQ;
